...
- (void)presentAsKeyboardAnimationDidStop {
  [SNNotificationManager  postNotificationName:UIKeyboardDidShowNotification
                                                      object:self
                                                    userInfo:[self
...
- (void)dismissAsKeyboardAnimationDidStop {
  [SNNotificationManager  postNotificationName:UIKeyboardDidHideNotification
                                                      object:self
                                                    userInfo:[self
                                                              userInfoForKeyboardNotification]];
...
- (void)presentAsKeyboardInView:(UIView*)containingView {
  [SNNotificationManager  postNotificationName:UIKeyboardWillShowNotification
                                                      object:self
                                                    userInfo:[self
                                                              userInfoForKeyboardNotification]];
...
- (void)dismissAsKeyboard:(BOOL)animated {
  [SNNotificationManager  postNotificationName:UIKeyboardWillHideNotification
                                                      object:self
                                                    userInfo:[self
                                                              userInfoForKeyboardNotification]];
