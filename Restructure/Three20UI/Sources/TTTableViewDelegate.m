...
- (void)tableView:(UITableView*)tableView didSelectRowAtIndexPath:(NSIndexPath*)indexPath {
    ...
    if (self.isSelected == NO) {
        self.isSelected = YES;
        [self performSelector:@selector(didSelectRow) withObject:nil afterDelay:1.0];
        CGRect rectInTableView = [tableView rectForRowAtIndexPath:indexPath];
        CGRect rectInScreen = [tableView convertRect:rectInTableView toView:[tableView superview]];
        [[NSUserDefaults standardUserDefaults] setDouble:rectInScreen.origin.y forKey:@"kRememberCellOriginYInScreen"];
