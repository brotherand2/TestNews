...
- (void)presentModalController: (UIViewController*)controller
  ...
  if ([controller isKindOfClass:[UINavigationController class]]) {
    ...
    UIViewController* navController = [[[[self navigationControllerClass] alloc] initWithRootViewController:controller]
                                             autorelease];
...
- (UIViewController*)openURLAction:(TTURLAction*)action {
  ...
  if (nil == theURL.scheme) {
    if (nil != theURL.fragment) {
      ...
      urlPath = [@"https://" stringByAppendingString:urlPath];
    }
