...
static const  CGFloat   kLargeImageSize = 960 * 640;
...
- (BOOL)hasDataForURL:(NSString*)URL {
  ...
  BOOL exist = [fm fileExistsAtPath:filePath];
    if (!exist) {
        NSString *tmp = nil;
        if (   [URL hasPrefix:@"http://cache.k.sohu.com/img7"]||[URL hasPrefix:@"http://cache.k.sohu.com/img8"]
            || [URL hasPrefix:@"https://cache.k.sohu.com/img7"]||[URL hasPrefix:@"https://cache.k.sohu.com/img8"]) {
            if ([URL hasSuffix:@".jpg"]) {
                tmp = [URL stringByReplacingOccurrencesOfString:@".jpg" withString:@".webp"];
            } else {
                tmp = [URL stringByReplacingOccurrencesOfString:@".webp" withString:@".jpg"];
            }
        }
        filePath = [self cachePathForURL:tmp];
...
- (NSData*)dataForURL:(NSString*)URL {
    NSData* data = [self dataForURL:URL expires:TT_CACHE_EXPIRATION_AGE_NEVER timestamp:nil];
    if (!data) {
        if (   [URL hasPrefix:@"http://cache.k.sohu.com/img7"]||[URL hasPrefix:@"http://cache.k.sohu.com/img8"]
            || [URL hasPrefix:@"https://cache.k.sohu.com/img7"]||[URL hasPrefix:@"https://cache.k.sohu.com/img8"]) {
            if ([URL hasSuffix:@".jpg"]) {
                URL = [URL stringByReplacingOccurrencesOfString:@".jpg" withString:@".webp"];
            } else {
                URL = [URL stringByReplacingOccurrencesOfString:@".webp" withString:@".jpg"];
            }
        }
        data = [self dataForURL:URL expires:TT_CACHE_EXPIRATION_AGE_NEVER timestamp:nil];
    }
...
- (id)imageForURL:(NSString*)URL {
    UIImage *image = [self imageForURL:URL fromDisk:YES];
    if (!image) {
        if (   [URL hasPrefix:@"http://cache.k.sohu.com/img7"]||[URL hasPrefix:@"http://cache.k.sohu.com/img8"]
            || [URL hasPrefix:@"https://cache.k.sohu.com/img7"]||[URL hasPrefix:@"https://cache.k.sohu.com/img8"]) {
            if ([URL hasSuffix:@".jpg"]) {
        ...
        image = [self imageForURL:URL fromDisk:YES];
    }
    return image;
}
...
- (void)storeData:(NSData*)data forKey:(NSString*)key {
    if (!_disableDiskCache) {
        if (_cachePath == nil) {
            _cachePath = [TTURLCache cachePathWithName:kDefaultCacheName];
        }
