...
@interface COMPFMResultSet : NSObject {
    COMPFMDatabase          *_parentDB;
    COMPFMStatement         *_statement;
...
@property (atomic, retain) COMPFMStatement *statement;
