...
@interface COMPFMDatabaseQueue : NSObject {
    NSString            *_path;
...
// If you need to nest, use COMPFMDatabase's startSavePointWithName:error: instead.
