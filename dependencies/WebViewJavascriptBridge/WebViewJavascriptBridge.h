...
// 为了防止与其他第三方库重复引用出现 duplicate symbols，
// 类名由 WebViewJavascriptBridge 修改为 SNWebViewJavascriptBridge
// by jojo

@interface SNWebViewJavascriptBridge : WVJB_WEBVIEW_DELEGATE_TYPE
