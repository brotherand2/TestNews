...
+ (NSString*) value {
    ...
    KeychainItemWrapper* wrapper = [[KeychainItemWrapper alloc] initWithIdentifier:@"kSohuNewsOpenUDID" accessGroup:nil];
    openUdid = [wrapper objectForKey:(id)kSecAttrAccount];
    if (openUdid.length == 0) {
        openUdid = [[OpenUDID valueWithError:nil] retain];
