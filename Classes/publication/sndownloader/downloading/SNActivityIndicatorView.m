...
@interface SNActivityIndicatorView ()
{
    NSTimer     *_timer;
...
@implementation SNActivityIndicatorView
...
- (void)_setPropertiesForStyle:(UIActivityIndicatorViewStyle)style
{
    ...
    self.direction = SNActivityIndicatorDirectionClockwise;
...
#pragma mark - SNActivityIndicator Drawing.
...
- (UIColor*)_colorForStep:(NSUInteger)stepIndex
{
    ...
    CGColorRef oldColor = CGColorCreateCopyWithAlpha(_color.CGColor, alpha);
...
- (CGPathRef)copyPathWithRect:(CGRect)rect
{
...
{    
    ...
    CGPathRef bezierPath = [self copyPathWithRect:finRect];
