...
@protocol SNScrollViewDataSource <NSObject>

- (NSInteger)numberOfPagesInScrollView:(SNScrollView*)scrollView;
 ...
 */
- (UIView*)scrollView:(SNScrollView*)scrollView pageAtIndex:(NSInteger)pageIndex;
 ...
 */
- (CGSize)scrollView:(SNScrollView*)scrollView sizeOfPageAtIndex:(NSInteger)pageIndex;
