...
@property(nonatomic, retain) NSDictionary *queryDic;
@property (nonatomic, retain)SNGroupPicturesSlideshowContainerViewController *groupPicturesSlideshowContainerViewController;
