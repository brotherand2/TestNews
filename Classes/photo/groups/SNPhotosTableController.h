...
@property(nonatomic, retain)UIView *coverLayerView;
...
@property(nonatomic, retain)SNChannelScrollTabBar *tabBar;
@property(nonatomic, copy)NSString *titleString;
@property(nonatomic, retain)NSIndexPath *lastIndexPath;
@property(nonatomic, readonly)BOOL isCreated;
@property(nonatomic, retain)SNPhotoTableDelegate *dragDelegate;
