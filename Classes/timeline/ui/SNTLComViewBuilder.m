...
- (void)dealloc {
    ...
    TT_RELEASE_SAFELY(_btnClickAction);
    [super dealloc];
}
    ...
    if ([object isKindOfClass:[SNTimelineOriginContentObject class]]) {
        ...
        switch (obj.type) {
            case SNTimelineOriginContentTypeText: {
                SNTLComViewOnlyTextBuilder *builder = [[SNTLComViewOnlyTextBuilder new] autorelease];
...
+ (SNTLCommonView *)viewForObject:(id)object {
    ...
    if ([object isKindOfClass:[SNTimelineOriginContentObject class]]) {
        ...
        switch (obj.type) {
            ...
            case SNTimelineOriginContentTypeTextAndPics: {
                SNTLComViewTextAndPicsBuilder *builder = [[SNTLComViewTextAndPicsBuilder new] autorelease];
                builder.title = obj.abstract;
                builder.fromString = obj.fromString;
