...
// colors
#define kTLViewTitleTextColor                   (@"kTLViewTitleTextColor")
#define kTLViewFromTextColor                    (@"kTLViewFromTextColor")

#define kTLLoginBtnTextColor                    (@"kTLLoginBtnTextColor")
...
#define kTLViewWidth                            (528 / 2)
#define kTLViewWidthForShare                    (612 / 2)
...
#define kTLCommentsViewTextWidth                ((506 - 32) / 2)
...
#define kTLOriginalPeopleViewLineNum            (5)
