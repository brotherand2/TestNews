...
@property (nonatomic, retain)UIImage *cmtImage;
...
- (void)commentAction
{
//    [[NSNotificationCenter defaultCenter]postNotificationName:kTLTrendSendComment object:self.actId];
