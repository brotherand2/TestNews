...
@interface SNTimelineTrendCell : SNTableViewCell<SNLabelDelegate, FGalleryPhotoViewDelegate,
...
@property (nonatomic, retain)SNTimelineTrendItem *timelineTrendObj;
...
@property (nonatomic, retain)UILabel *cmtNumLabel;
