...
- (id)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        NSString *normalString = @"ding_normal.png";
        NSString *highlightString = @"ding_highlight.png";
        UIImage *normalImage = [[UIImage imageNamed:normalString] scaledImage];
        UIImage *highlightImage = [[UIImage imageNamed:highlightString] scaledImage];
...
- (void)dealloc{
    ...
    TT_RELEASE_SAFELY(_dingImageView);
    [super dealloc];
}
