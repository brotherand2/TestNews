...
- (id)initWithNavigatorURL:(NSURL*)URL query:(NSDictionary*)query {
    if (self = [super initWithNavigatorURL:URL query:query]) {
        ...
        _pubDate = [query objectForKey:kPubDate];
        ...
        SNPhotoSlideshow *slideshow = [[SNPhotoSlideshow alloc] initWithTermId:self.termId newsId:self.currentNewsId channelId:channelId isOnlineMode:_isOnlineMode];
        ...
        if (!_logo) {
            _logo = [[UIImageView alloc] initWithImage:[UIImage themeImageNamed:@"app_logo_gray.png"]];
...
- (void)openSlideshowAtNewsId:(NSString *)newsId
{
    ...
    SNPhotoSlideshow *slideshow = [[SNPhotoSlideshow alloc] initWithTermId:self.termId newsId:newsId channelId:self.gallery.channelId isOnlineMode:_isOnlineMode];
