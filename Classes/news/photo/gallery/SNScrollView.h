...
@protocol SNScrollViewDelegate;
@protocol SNScrollViewDataSource;
...
@interface SNScrollView : UIView {
  ...
  id<SNScrollViewDelegate>    __weak _delegate;
  id<SNScrollViewDataSource>  __weak _dataSource;
...
@property (nonatomic, weak) id<SNScrollViewDelegate>    delegate;
@property (nonatomic, weak) id<SNScrollViewDataSource>  dataSource;
@property (nonatomic, strong) NSMutableArray* pages;
/**
 * A dictionary of visible pages keyed by the index of the page.
 */
@property (weak, nonatomic, readonly) NSDictionary* visiblePages;
